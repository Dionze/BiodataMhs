...
// sourcecode untuk URL ->URL menggunakan IP address default eclipse
	String URL = "http://192.168.8.101/tips_crud_android_json_mysql/server.php";
	String url = "";
	String response = "";
...
public String insertBiodata(String nim,
							String nama,
							String alamat) {
	try{
		url = URL + "?operasi=insert&nim=" 	  + nim + 
								   "&nama="   + nama + 
								   "&alamat=" + alamat;
...
public String updateBiodata(String id, 
							String nim, 
							String nama, 
							String alamat) {
	try{
		url=URL + "?operasi=update&id=" 	+ id + 
								 "&nim=" 	+ nim + 
								 "&nama=" 	+ nama + 
								 "&alamat=" + alamat;
